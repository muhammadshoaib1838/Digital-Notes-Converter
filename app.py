            ...
            with st.spinner("Styling your document..."):
                try:
                    ...
                    if img is None:
                        ...
                        # UPDATED PROMPT: Requesting HTML colors for headings and keywords
                        prompt = f"""
                        Convert this text into a professional document. 
                        1. Use <h2 style='color:#38bdf8;'>Heading Name</h2> for all headings.
                        2. Use <span style='color:#fbbf24; font-weight:bold;'>Term</span> for important keywords or values.
                        3. Use standard text for the rest.
                        4. End with '--- FINAL SUMMARY ---'.
